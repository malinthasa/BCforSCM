...
# Invoke chaincode on peer0.ibo, peer0.org2, and peer0.org3
echo "Sending invoke transaction on peer0.ibo peer0.org2 peer0.org3..."
chaincodeInvoke 0 1 0 2 0 3

# Query on chaincode on peer0.org3, peer0.org2, peer0.ibo check if the result is 80
